...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/stochastic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11791&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/stochastic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `stochastic` can be installed with:

```
conda install stochastic
```

It is possible to list all of the versions of `stochastic` available on your platform with:
